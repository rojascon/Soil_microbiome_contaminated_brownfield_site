...
#               and retain those >0.1% average relative abundance 
################################################################################
...
#save df for LEfSe
write.table(df1, "16S rRNA marker/data/07_contam_surface_lefse.txt", 
...
#Step1: Upload data frame from above by going to Get Data > 
...
#Select which row to use as class: use #1 contamination 
#click EXECUTE
...
lefse=read.csv("16S rRNA marker/data/07_lefse_output.csv", header=T);
