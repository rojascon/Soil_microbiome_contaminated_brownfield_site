...
##bacterial phylum, and order taxonomic levels for each soil depth
...
phy_col=c("#1B9E77","#D95F02", "#7570B3", "#E7298A" ,"#66A61E" ,"#E6AB02", "#A6761D" , 
        "#253494", "#FC8D62", "#969696","#8DA0CB", "#ae017e", "#A6D854","#E5C494" ,
        "#666666");
...
#keep orders >1.5% relative abundance across samples
order$AVG=rowMeans(order[,-1]);
order=order[order$AVG>1.48,]; #1.58 mothur2
order$AVG=NULL;
...
ord_col=c("#771155", "#AA4488", "#CC99BB", "#114477", "#4477AA", "#77AADD", 
          ...
          "#737373","#117744","#88CCAA","#777711", "#fc8d59", "#fed976",
