...
#subsampled to 21,000 sequences each
...
#samples to 21,000 sequences each using the mothur software
...
#Step1: open data file "18S rRNA marker/
...
mrare=read.table("18S rRNA marker/data/08_rarefaction_mothur.txt", 
                 sep="\t", header=TRUE);
...
rfc=ggplot(data=rare_meta) + 
  ...
  labs(x = "Number of Reads",
       y = "ASV Richness",
       colour= "Depth (m)")+
  ggtitle("Rarefaction Curves -18S rRNA profiles")+
  theme_bw() +
