...
##CODE FOR: 
#A) subsampling samples to 21,000 sequences each using mothur software 
...
################################################################################
#             1. Prepara data for subsampling to 21,000 sequences    
...
#21,000 appears like a good cutoff (only losing 4 samples)
...
write.table(mothur, file="18S rRNA marker/data/05_input_mothur.txt", 
            row.names=F, sep="\t");
...
#           sub.sample(shared=05_input_mothur.txt, size=21000, persample=true)
#step4: rename output file as "05_output_mothur.txt") and place in the data directory

#PASTE Output from mothur here
#X18S_1_12_S12_L001 contains 13131. Eliminating.
#X18S_1_18_S18_L001 contains 17973. Eliminating.
#X18S_1_6_S6_L001 contains 19294. Eliminating.
#X18S_1_9_S9_L001 contains 14485. Eliminating.
...
mothur2=read.table("18S rRNA marker/data/05_output_mothur.txt", sep="\t",header=T);
...
################################################################################
save(alpha_meta, file="18S rRNA marker/data/05_alpha_diversity.Rdata");
