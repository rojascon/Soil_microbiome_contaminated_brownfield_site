...
write.table(dfA, "18S rRNA marker/data/07_depth_phylum_lefse.txt", 
            col.names=NA,row.names=TRUE,sep="\t");

write.table(dfB, "18S rRNA marker/data/07_depth_order_lefse.txt", 
            col.names=NA,row.names=TRUE,sep="\t");

write.table(dfC, "18S rRNA marker/data/07_depth_genus_lefse.txt", 
            col.names=NA,row.names=TRUE,sep="\t");
