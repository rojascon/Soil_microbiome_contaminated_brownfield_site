...
load("fungal ITS marker/data/05_alpha_diversity.Rdata");

#recode depth variable as 0.15 vs. greater than 0.15
alpha_meta$depth2=TRUE;
alpha_meta$depth2[alpha_meta$sample_depth>0.15]=FALSE;
...
#define model
m1=lmer(log(Chao2)~ depth2 + (1|core), 
...
#for fungal ITS data = Cobalt 

pred1<-ggeffects::ggpredict(m3, terms = c("Cobalt"));
